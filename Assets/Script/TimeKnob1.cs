...
public class TimeKnob1 : MonoBehaviour
{
    ...
    bool invoke=false;
    public static TimeKnob1 instance;
    private void Awake()
    {
        instance=this;
    }
    ...
    {
        seconds = PlayerPrefs.GetInt("Second1", 0);
        minutes = PlayerPrefs.GetInt("Minute1", 0);
    ...
    private void Update()
    {
        if (!SetTime)
        {
            if (currentTime > 0)
            {
                ...
                PlayerPrefs.SetInt("Minute1", remainingMinutes);
                PlayerPrefs.SetInt("Second1", remainingSeconds);
    ...
    public void IncreaseMinutes()
    {
        ...
        RotateKnob(180f);
        Minute.text = minutes.ToString("D2");
        PlayerPrefs.SetInt("Minute1", minutes);
    }
    ...
    public void IncreaseSeconds()
    {
        ...
        if (S == 6)
        {
            ...
            S = 0;
            PlayerPrefs.SetInt("Minute1", minutes);
            PlayerPrefs.SetInt("Second1", seconds);
        }
        else
        {
            RotateKnob(36f);
