...
namespace BzKovSoft.ObjectSlicer.Samples
{
    ...
    public class SampleMouseSlicer : MonoBehaviour
    {
        ...
        Vector3 CuttingCoroutineposition,hitpoint;
        ...
        private void Update()
        {
            ...
            if (Physics.Raycast(transform.position,-transform.up, out hit6, 1))
            {
                ...
                if (hit6.transform.tag == "onion" || hit6.transform.tag == "lemon" || hit6.transform.tag == "potato" || hit6.transform.tag == "tomato" || hit6.transform.tag == "meat"||hit6.transform.name == "CuttingBoard")
                {
        ...
        void OnTriggerEnter(Collider other)
        {
            ...
            if (other.transform.CompareTag("onion")|| other.transform.CompareTag("lemon") || other.transform.CompareTag("potato1") || other.transform.CompareTag("potato") || other.transform.CompareTag("tomato") || other.transform.CompareTag("meat"))
            {
                print("working");
        ...
        void PerformSlice(IBzSliceableNoRepeat sliceable)
        {
            ...
            if (Physics.Raycast(transform.position + new Vector3(0.02f, 0, 0), -transform.up, out hits, 1))
            {
                Debug.DrawRay(transform.position, -transform.up * hits.distance, Color.green);
                // Access information about the hit object
                GameObject hitObject = hits.collider.gameObject;
            ...
            if (Physics.Raycast(transform.position + new Vector3(0, 0, 0.04f), -transform.up, out hits, 1))
            {
                Debug.DrawRay(transform.position, -transform.up * hits.distance, Color.green);
                // Access information about the hit object
                GameObject hitObject = hits.collider.gameObject;
            ...
            }if (Physics.Raycast(transform.position + new Vector3(0.04f, 0, 0), -transform.up, out hits, 1))
            {
                Debug.DrawRay(transform.position, -transform.up * hits.distance, Color.green);
                // Access information about the hit object
                GameObject hitObject = hits.collider.gameObject;
        ...
        {
            input = false;
            CuttingCoroutineposition = transform.position;
        ...
        {
            Vector3 b = transform.position;
            Vector3 targetPos = CuttingCoroutineposition;
