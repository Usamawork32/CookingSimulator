	...
	public class RandomMove : MonoBehaviour
	{
		...
		void Update ()
		{
			...
			if (automatic) {
                ...
                } else if (ControlFreak2.CF2Input.GetKey(KeyCode.LeftArrow)) {
                    accel = Vector3.left * speed;
                } else if (ControlFreak2.CF2Input.GetKey(KeyCode.UpArrow)) {
                    accel = Vector3.forward * speed;
                } else if (ControlFreak2.CF2Input.GetKey(KeyCode.DownArrow)) {
